...
```md
<img class="article-images" src="/test.png" alt="テスト" loading="lazy">
```

↓

```html
<img class="article-images" src="/test.png" alt="テスト">
```
...
export default {
  ...
  <img class="article-images" src="${href}.png" alt="${text}">
</picture>`
...
```md
<img class="article-images" src="/test" alt="テスト" loading="lazy">
```
